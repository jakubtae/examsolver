...
router.get("/", (req, res) => {
  res.render("inf02/inf02.ejs");
});

//! CHANGE TESTING TO SOLVE AND DELETE SOLVE FROM UP
//! COPY THIS ROUTE TO INF03 file
//! CHANGE THE CODE TO BE COPIED TO A NEW ONE FROM securescripttocopy.js IN INF02 view and INF03 view
//! WHILE ALSO CHANGING THE URL VALUE TO A PROPER ONE
            ...
            async function update() {
              await users
                ...
                .then(() => {
                  ...
                  var fileString2 = fs.readFileSync("data2.json").toString();
